...
#
# Generated by Vivado on Sun Jan 26 22:00:07 -0800 2020
...
# Script info
echo -e "blk_mem_gen_0.sh - Script generated by export_simulation (Vivado v2017.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_0 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_0 xil_defaultlib.blk_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_timing_module:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -log simulate.log
}
