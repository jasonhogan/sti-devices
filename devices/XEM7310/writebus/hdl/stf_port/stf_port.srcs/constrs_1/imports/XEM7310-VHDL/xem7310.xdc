...
## MC2-15
#set_property PACKAGE_PIN P5 [get_ports {testMC1[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {testMC1[0]}]


### MC1-16
##set_property PACKAGE_PIN V9 [get_ports {testMC1[0]}]
##set_property IOSTANDARD LVCMOS33 [get_ports {testMC1[0]}]

## MC1-18
#set_property PACKAGE_PIN V8 [get_ports {testMC1[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {testMC1[1]}]

## MC1-20
#set_property PACKAGE_PIN V7 [get_ports {testMC1[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {testMC1[2]}]
...
set_output_delay -clock [get_clocks sys_clk] -min -add_delay -0.500 [get_ports {led[*]}]
set_output_delay -clock [get_clocks sys_clk] -max -add_delay 1.500 [get_ports {led[*]}]
set_output_delay -clock [get_clocks sys_clk] -min -add_delay -0.500 [get_ports {xbusp[*]}]
set_output_delay -clock [get_clocks sys_clk] -max -add_delay 1.500 [get_ports {xbusp[*]}]
set_output_delay -clock [get_clocks okUH0] -min -add_delay -0.500 [get_ports okAA]
set_output_delay -clock [get_clocks okUH0] -max -add_delay 1.500 [get_ports okAA]
