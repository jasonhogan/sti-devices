...
HD_PWD='C:/Users/SrLab/Documents/code/dev/sti-devices/devices/XEM7310/statemachine/timingcoresim/timingcoresim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timing_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timing_core.tcl
